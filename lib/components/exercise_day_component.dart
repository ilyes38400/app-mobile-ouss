  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      userStore.subscription == "1"
          ? ExerciseDetailScreen(mExerciseName: widget.mDayExerciseModel!.exerciseTitle.validate(), mExerciseId: widget.mDayExerciseModel!.exerciseId.validate(), mSets: widget.mDayExerciseModel!.sets).launch(context)
