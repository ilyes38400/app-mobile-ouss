            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Image.asset(ic_ideal_weight, width: 22, height: 22, color: primaryColor),
                ),
                Text(languages.lblIdealWeight, style: boldTextStyle(size: 18, color: appStore.isDarkMode ? primaryColor : black), overflow: TextOverflow.ellipsis, maxLines: 1),
              ],
            ),
            12.height,
