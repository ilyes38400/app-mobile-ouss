...
class SubscriptionModel {
  ...
  SubscriptionModel({this.id, this.name, this.duration, this.durationUnit, this.price, this.description, this.status, this.createdAt, this.updatedAt, this.title, this.type, this.programType});
