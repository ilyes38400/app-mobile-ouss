...
class WorkoutDetailModel {
  ...
  WorkoutDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    requiresPurchase = json['requires_purchase'];
    requiresSubscription = json['requires_subscription'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['access_reason'] = this.accessReason;
    data['requires_purchase'] = this.requiresPurchase;
