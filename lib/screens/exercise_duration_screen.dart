    ...
    if (youtubePlayerController != null)
      youtubePlayerController!.addListener(() {
        ...
        if (_playerState == PlayerState.paused) {
          ...
          if (_soundEnabled) flutterTts.pause();
          isChanged = true;
        }
      });
...
/*            SizedBox(
              ...
              child: CountDownProgressIndicator(
                ...
                initialPosition: 0,
                duration: widget.mExerciseModel!.data!.duration.isEmptyOrNull ? widget.mExerciseModel!.data!.duration!.toInt() : duration1!.inSeconds,
